...
"border-style:outset;")
        ...
        self.label_performance.setGeometry(QtCore.QRect(830, 20, 90, 90))
        font = QtGui.QFont()
...
"")
        ...
        self.label_ratio.setGeometry(QtCore.QRect(1000, 190, 260, 50))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_unit_interrupt_counts.setGeometry(QtCore.QRect(1000, 240, 260, 50))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(12)
        font.setBold(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_ratio.setText(_translate("MainWindow", "中斷時間佔比:   尚未進行偵測"))
        self.label_unit_interrupt_counts.setText(_translate("MainWindow", "單位時間中斷次數:   尚未進行偵測"))
